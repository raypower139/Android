...
class Settings : AppCompatActivity(), AnkoLogger, NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // navView.setNavigationItemSelectedListener(this)
        ...
        //var allHillforts = app.hillforts.findAll().size
        //numberOfHillforts.setText(allHillforts)
        //var visitedHillforts = app.hillforts.findAll().filter { it.visited }.size
        //numberOfHillfortsVisited.setText(visitedHillforts)
